...
void(* SoftwareReset) (void) = 0;
  ...
  void lcd_main_menu() {
    ...
    MENU_ITEM(submenu, MSG_leveling, lcd_auto_leveling_menu);
...
void lcd_auto_leveling_menu() {
    ...
    MENU_ITEM(gcode, MSG_GO_G36, PSTR("G36"));
    MENU_ITEM(submenu, MSG_G35, lcd_G35_menu);
  
  //MENU_ITEM(gcode, MSG_Z_JIA1, PSTR("M857 B"));
  MENU_ITEM(gcode, MSG_Z_JIA01, PSTR("M857 A"));
 // MENU_ITEM(gcode, MSG_Z_JIAN1, PSTR("M857 E"));
  MENU_ITEM(gcode, MSG_Z_JIAN01, PSTR("M857 F"));
   // MENU_ITEM(gcode, MSG_Z_JIA03, PSTR("M857 C"));
    //  MENU_ITEM(gcode, MSG_Z_JIAN03, PSTR("M857 D"));
  MENU_ITEM(gcode, MSG_STORE_Z, PSTR("M500"));
  //MENU_ITEM(gcode, MSG_GO_G36, PSTR("G36"));
  ...
  void lcd_G35_menu() {
    START_MENU();
    MENU_BACK(MSG_leveling);
  
  
    MENU_ITEM(gcode, MSG_GO_G35, PSTR("G35"));
    //MENU_ITEM(submenu, MSG_SET_ZOFFSET, lcd_G35_menu);
//MENU_ITEM_EDIT(float32, MSG_ZPROBE_ZOFFSET, &zprobe_zoffset, Z_PROBE_OFFSET_RANGE_MIN, Z_PROBE_OFFSET_RANGE_MAX);
MENU_ITEM_EDIT(float32, MSG_ZPROBE_ZOFFSET1, &aaaa, Z_PROBE_OFFSET_RANGE_MIN, Z_PROBE_OFFSET_RANGE_MAX);
MENU_ITEM_EDIT(float32, MSG_ZPROBE_ZOFFSET, &zprobe_zoffset, Z_PROBE_OFFSET_RANGE_MIN, Z_PROBE_OFFSET_RANGE_MAX);
//  MENU_ITEM(function, MSG_STORE_Z, Config_StoreSettings);
MENU_ITEM(gcode, MSG_STORE_Z, PSTR("G33"));
