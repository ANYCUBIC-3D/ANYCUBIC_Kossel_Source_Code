...
//  #define DELTA_CARRIAGE_OFFSET 15.5 // mm
  ...
  #define DELTA_RADIUS 135.4 //(DELTA_SMOOTH_ROD_OFFSET-(DELTA_EFFECTOR_OFFSET)-(DELTA_CARRIAGE_OFFSET))

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
//  #define DELTA_PRINTABLE_RADIUS 120
#define DELTA_PRINTABLE_RADIUS 105//118
...
#define Z_PROBE_SPEED_SLOW Z_PROBE_SPEED_FAST/4   //2019.4.13
